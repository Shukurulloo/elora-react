...
import { SocketProvider } from "./app/context/SocketContext";// SocketProviderni itegratsia qilamz
...
root.render(
  //(vertualdom) ReactDOM olib ustida renderni amalga oshirib ichiga 1-argument react(vertualdom) srcni joylaymiz
  <React.StrictMode>
